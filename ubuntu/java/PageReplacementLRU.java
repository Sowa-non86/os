...
public class PageReplacementLRU {
    ...
    // Find the index of the Least Recently Used (LRU) frame
    static int findLRU(int n) {
    ...
    static void lru(int numFrames, int numPages) {
        initialize();
